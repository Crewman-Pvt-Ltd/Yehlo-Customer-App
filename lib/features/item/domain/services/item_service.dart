...
class ItemService implements ItemServiceInterface {
  ...
  Future<List<Item>?> getPopularItemList(String type) async {
    return await itemRepositoryInterface.getList(
        type: type, isPopularItem: true);
  }

  @override
  Future<ItemModel?> getReviewedItemList(String type) async {
    return await itemRepositoryInterface.getList(
        type: type, isReviewedItem: true);
  }
  ...
  Future<List<Item>?> getRecommendedItemList(String type) async {
    return await itemRepositoryInterface.getList(
        type: type, isRecommendedItems: true);
  }

  @override
  Future<List<Item>?> getDiscountedItemList(String type) async {
    return await itemRepositoryInterface.getList(
        isDiscountedItems: true, type: type);
  }
  ...
  @override
  int setQuantity(bool isIncrement, bool moduleStock, int? stock, int qty,
      int? quantityLimit,
