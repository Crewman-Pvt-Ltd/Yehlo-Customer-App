...
import 'package:yehlo_User/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:yehlo_User/features/checkout/widgets/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:yehlo_User/features/checkout/widgets/bottom_section.dart';
import 'package:yehlo_User/features/checkout/widgets/top_section.dart';
          ...
          if (disType == 'percent' && discount != 0) {
            discount = discount +
                _calculateVariationPrice(
                    store: store, cartList: cartList, calculateDiscount: true);
          }
        } else {
          String variationType = '';
          double variationPrice = 0;
