...
import 'package:yehlo_User/features/checkout/widgets/note_prescription_section.dart';
      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            storeId == null ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('${'Gst'.tr} ${taxIncluded ? 'tax_included'.tr : ''} ($taxPercent%)', style: robotoRegular),
