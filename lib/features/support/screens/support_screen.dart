...
import 'package:yehlo_User/features/support/widgets/web_help_support_widget.dart';
...
import 'package:yehlo_User/features/support/widgets/support_button_widget.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Center(child: FooterView(
          child: ResponsiveHelper.isDesktop(context) ? const SizedBox(
            ...
            Image.asset(Images.supportImage, height: 100),
