...
import 'package:yehlo_User/common/models/translation.dart';
...
import 'package:yehlo_User/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:yehlo_User/features/auth/widgets/pass_view_widget.dart';
import 'package:yehlo_User/features/auth/widgets/select_location_view_widget.dart';
            ...
            ResponsiveHelper.isDesktop(context)
                ...
                : Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          Text(
                            storeRegController.storeStatus == 0.4
                            ...
                            children: [
                              ...
                              Stack(children: [
                                ...
                                Positioned(
                                  ...
                                  left: 0,
                                  child: InkWell(
                                    onTap: () => storeRegController.pickImage(
                                        true, false),
                                    child: DottedBorder(
                                      color: Theme.of(context).primaryColor,
                                      strokeWidth: 1,
                            ...
                            Positioned(
                              ...
                              child: InkWell(
                                ...
                                child: DottedBorder(
                                  ...
                                  child: Center(
                                    child: Visibility(
                                      visible: storeRegController.pickedCover !=
                                          null,
                                      child: Container(
                                        padding: const EdgeInsets.all(25),
                                        decoration: BoxDecoration(
  ...
  Widget buttonView() {
    return GetBuilder<StoreRegistrationController>(
      ...
      return CustomButton(
        ...
        buttonText: storeRegController.storeStatus == 0.4 &&
                !ResponsiveHelper.isDesktop(context)
            ? 'next'.tr
            : 'submit'.tr,
        onPressed: () {
          ...
          if (storeRegController.storeStatus == 0.4 &&
              !ResponsiveHelper.isDesktop(context)) {
            ...
            if (fName.isEmpty) {
              ...
              storeRegController.registerStore(StoreBodyModel(
                ...
                lat: storeRegController.restaurantLocation!.latitude.toString(),
                email: email,
                lng:
                    storeRegController.restaurantLocation!.longitude.toString(),
                fName: fName,
                lName: lName,
                ...
                moduleId: storeRegController
                    .moduleList![storeRegController.selectedModuleIndex!].id
                    .toString(),
