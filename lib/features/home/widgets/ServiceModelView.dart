...
class ServiceModelView extends StatelessWidget {
  ...
  const ServiceModelView({super.key, required this.splashController});
              ...
              child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/image/LaundryServices.png', // Path to your image asset
                        height: 76,
                        width: 76,
                        fit: BoxFit.cover, // Adjusts how the image should be fitted within the widget
                      ),
                    ),
                    const SizedBox(
                      height: 0,
                  ...
                  children: [
                    ClipRRect(
                      borderRadius:
                          BorderRadius.circular(Dimensions.radiusSmall),
                      child: Image.asset(
                        'assets/image/AcRepair.png', // Path to your image asset
                        height: 76,
                        width: 76,
                        fit: BoxFit
                            .cover, // Adjusts how the image should be fitted within the widget
                      ),
                    ),
                    const SizedBox(
                      height: 0,
                  ...
                  children: [
                    ClipRRect(
                      borderRadius:
                          BorderRadius.circular(Dimensions.radiusSmall),
                      child: Image.asset(
                        'assets/image/Shifting_Services.png', // Path to your image asset
                        height: 76,
                        width: 76,
                        fit: BoxFit
                            .cover, // Adjusts how the image should be fitted within the widget
