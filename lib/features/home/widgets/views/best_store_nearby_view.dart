...
import 'package:yehlo_User/common/widgets/card_design/store_card.dart';
import 'package:yehlo_User/common/widgets/card_design/store_card_with_distance.dart';
...
import 'package:yehlo_User/common/widgets/discount_tag.dart';
          ...
          child: Column(children: [
            ...
            storeList != null
                ? storeList.isNotEmpty
                                                                    ...
                                                                    child: Row(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              ...
                                                                              style: robotoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                          const SizedBox(
                                                                              width: Dimensions.paddingSizeExtraSmall),
                                                                          Text(
                                                                              'from_you'.tr,
                                                                              style: robotoRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                        ]),
                                                                  ),
                                                                ),
                                                              ]),
                    ...
                    : const SizedBox()
                : BestStoreNearbyShimmer(
                    isPharmacy: isPharmacy, isFood: isFood),
          ]),
        ),
      );
    });
