import 'dart:convert';
import 'package:yehlo_User/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:yehlo_User/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:yehlo_User/features/taxi_booking/controllers/booking_checkout_controller.dart';
import 'package:yehlo_User/features/taxi_booking/controllers/car_selection_controller.dart';
...
import 'package:yehlo_User/features/banner/domain/repositories/banner_repository.dart';
import 'package:yehlo_User/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:yehlo_User/features/banner/domain/services/banner_service.dart';
import 'package:yehlo_User/features/banner/domain/services/banner_service_interface.dart';
import 'package:yehlo_User/features/cart/domain/repositories/cart_repository.dart';
import 'package:yehlo_User/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:yehlo_User/features/cart/domain/services/cart_service.dart';
import 'package:yehlo_User/features/cart/domain/services/cart_service_interface.dart';
import 'package:yehlo_User/features/category/controllers/category_controller.dart';
import 'package:yehlo_User/features/category/domain/reposotories/category_repository.dart';
import 'package:yehlo_User/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:yehlo_User/features/category/domain/services/category_service.dart';
import 'package:yehlo_User/features/category/domain/services/category_service_interface.dart';
import 'package:yehlo_User/features/chat/controllers/chat_controller.dart';
import 'package:yehlo_User/features/chat/domain/repositories/chat_repository.dart';
import 'package:yehlo_User/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:yehlo_User/features/chat/domain/services/chat_service.dart';
import 'package:yehlo_User/features/chat/domain/services/chat_service_interface.dart';
import 'package:yehlo_User/features/coupon/controllers/coupon_controller.dart';
import 'package:yehlo_User/features/coupon/domain/services/coupon_service.dart';
import 'package:yehlo_User/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:yehlo_User/features/favourite/controllers/favourite_controller.dart';
import 'package:yehlo_User/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:yehlo_User/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:yehlo_User/features/favourite/domain/services/favourite_service.dart';
import 'package:yehlo_User/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:yehlo_User/features/flash_sale/controllers/flash_sale_controller.dart';
import 'package:yehlo_User/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:yehlo_User/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:yehlo_User/features/flash_sale/domain/services/flash_sale_service.dart';
import 'package:yehlo_User/features/flash_sale/domain/services/flash_sale_service_interface.dart';
import 'package:yehlo_User/features/html/controllers/html_controller.dart';
import 'package:yehlo_User/features/html/domain/repositories/html_repository.dart';
import 'package:yehlo_User/features/html/domain/repositories/html_repository_interface.dart';
import 'package:yehlo_User/features/html/domain/services/html_service.dart';
import 'package:yehlo_User/features/html/domain/services/html_service_interface.dart';
...
import 'package:yehlo_User/features/item/domain/repositories/campaign_repository.dart';
import 'package:yehlo_User/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:yehlo_User/features/item/domain/repositories/item_repository.dart';
import 'package:yehlo_User/features/item/domain/repositories/item_repository_interface.dart';
import 'package:yehlo_User/features/item/domain/services/campaign_service.dart';
import 'package:yehlo_User/features/item/domain/services/campaign_service_interface.dart';
import 'package:yehlo_User/features/item/domain/services/item_service.dart';
import 'package:yehlo_User/features/item/domain/services/item_service_interface.dart';
import 'package:yehlo_User/features/language/controllers/language_controller.dart';
import 'package:yehlo_User/features/language/domain/repository/language_repository.dart';
import 'package:yehlo_User/features/language/domain/repository/language_repository_interface.dart';
import 'package:yehlo_User/features/language/domain/service/language_service.dart';
import 'package:yehlo_User/features/language/domain/service/language_service_interface.dart';
import 'package:yehlo_User/features/location/controllers/location_controller.dart';
import 'package:yehlo_User/features/taxi_booking/controllers/rider_controller.dart';
import 'package:yehlo_User/common/controllers/theme_controller.dart';
import 'package:yehlo_User/features/taxi_booking/repo/car_selection_repo.dart';
import 'package:yehlo_User/features/taxi_booking/repo/cart_repo.dart';
import 'package:yehlo_User/features/taxi_booking/repo/rider_repo.dart';
...
import 'package:yehlo_User/features/address/domain/repositories/address_repository.dart';
import 'package:yehlo_User/features/address/domain/repositories/address_repository_interface.dart';
import 'package:yehlo_User/features/address/domain/services/address_service.dart';
import 'package:yehlo_User/features/address/domain/services/address_service_interface.dart';
import 'package:yehlo_User/features/auth/controllers/auth_controller.dart';
import 'package:yehlo_User/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:yehlo_User/features/auth/controllers/store_registration_controller.dart';
import 'package:yehlo_User/features/auth/domain/reposotories/auth_repository.dart';
import 'package:yehlo_User/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:yehlo_User/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:yehlo_User/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:yehlo_User/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:yehlo_User/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:yehlo_User/features/auth/domain/services/auth_service.dart';
import 'package:yehlo_User/features/auth/domain/services/auth_service_interface.dart';
import 'package:yehlo_User/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:yehlo_User/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:yehlo_User/features/auth/domain/services/store_registration_service.dart';
import 'package:yehlo_User/features/auth/domain/services/store_registration_service_interface.dart';
import 'package:yehlo_User/features/checkout/controllers/checkout_controller.dart';
import 'package:yehlo_User/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:yehlo_User/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:yehlo_User/features/checkout/domain/services/checkout_service.dart';
import 'package:yehlo_User/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:yehlo_User/features/location/domain/repositories/location_repository.dart';
import 'package:yehlo_User/features/location/domain/repositories/location_repository_interface.dart';
import 'package:yehlo_User/features/location/domain/services/location_service.dart';
import 'package:yehlo_User/features/location/domain/services/location_service_interface.dart';
import 'package:yehlo_User/features/loyalty/controllers/loyalty_controller.dart';
import 'package:yehlo_User/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:yehlo_User/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:yehlo_User/features/loyalty/domain/services/loyalty_service.dart';
import 'package:yehlo_User/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:yehlo_User/features/notification/controllers/notification_controller.dart';
import 'package:yehlo_User/features/notification/domain/repository/notification_repository.dart';
import 'package:yehlo_User/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:yehlo_User/features/notification/domain/service/notification_service.dart';
import 'package:yehlo_User/features/notification/domain/service/notification_service_interface.dart';
import 'package:yehlo_User/features/onboard/controllers/onboard_controller.dart';
import 'package:yehlo_User/features/onboard/domain/repository/onboard_repository.dart';
import 'package:yehlo_User/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:yehlo_User/features/onboard/domain/service/onboard_service.dart';
...
import 'package:yehlo_User/features/order/domain/repositories/order_repository.dart';
import 'package:yehlo_User/features/order/domain/repositories/order_repository_interface.dart';
import 'package:yehlo_User/features/order/domain/services/order_service.dart';
import 'package:yehlo_User/features/order/domain/services/order_service_interface.dart';
import 'package:yehlo_User/features/parcel/controllers/parcel_controller.dart';
import 'package:yehlo_User/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:yehlo_User/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:yehlo_User/features/parcel/domain/services/parcel_service.dart';
import 'package:yehlo_User/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:yehlo_User/features/payment/controllers/payment_controller.dart';
import 'package:yehlo_User/features/payment/domain/repositories/payement_repository.dart';
import 'package:yehlo_User/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:yehlo_User/features/payment/domain/services/payment_service.dart';
import 'package:yehlo_User/features/payment/domain/services/payment_service_interface.dart';
import 'package:yehlo_User/features/profile/controllers/profile_controller.dart';
import 'package:yehlo_User/features/profile/domain/repositories/profile_repository.dart';
import 'package:yehlo_User/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:yehlo_User/features/profile/domain/services/profile_service.dart';
import 'package:yehlo_User/features/profile/domain/services/profile_service_interface.dart';
import 'package:yehlo_User/features/review/controllers/review_controller.dart';
import 'package:yehlo_User/features/review/domain/repositories/review_repository.dart';
import 'package:yehlo_User/features/review/domain/repositories/review_repository_interface.dart';
import 'package:yehlo_User/features/review/domain/services/review_service.dart';
import 'package:yehlo_User/features/review/domain/services/review_service_interface.dart';
import 'package:yehlo_User/features/search/controllers/search_controller.dart';
import 'package:yehlo_User/features/search/domain/repositories/search_repository.dart';
import 'package:yehlo_User/features/search/domain/repositories/search_repository_interface.dart';
import 'package:yehlo_User/features/search/domain/services/search_service.dart';
import 'package:yehlo_User/features/search/domain/services/search_service_interface.dart';
import 'package:yehlo_User/features/splash/controllers/splash_controller.dart';
import 'package:yehlo_User/features/splash/domain/repositories/splash_repository.dart';
import 'package:yehlo_User/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:yehlo_User/features/splash/domain/services/splash_service.dart';
...
import 'package:yehlo_User/features/store/domain/repositories/store_repository.dart';
import 'package:yehlo_User/features/store/domain/repositories/store_repository_interface.dart';
import 'package:yehlo_User/features/store/domain/services/store_service.dart';
import 'package:yehlo_User/features/store/domain/services/store_service_interface.dart';
import 'package:yehlo_User/features/verification/controllers/verification_controller.dart';
import 'package:yehlo_User/features/verification/domein/reposotories/verification_repository.dart';
import 'package:yehlo_User/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:yehlo_User/features/verification/domein/services/verification_service.dart';
import 'package:yehlo_User/features/verification/domein/services/verification_service_interface.dart';
import 'package:yehlo_User/features/wallet/controllers/wallet_controller.dart';
import 'package:yehlo_User/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:yehlo_User/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:yehlo_User/features/wallet/domain/services/wallet_service.dart';
